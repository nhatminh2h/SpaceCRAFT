...
print("Type 'MAKE' to craft items.")
...
def closet():
    print("\n Closet")
    print("There are spacesuits for expeditions like the one you were on. You don't need them on the ship.")
...
def ctrl_room():
    ...
    print("1 - Examine captain's body")#needs fixing
